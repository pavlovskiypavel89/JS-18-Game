...
// Запускаем игру. В качестве аргументов функция принимает: список схем уровней, парсер уровней и конструктор объекта, отвечающего за отрисовку игры в браузере (промис разрешится, когда игрок пройдет все уровни).
loadLevels()
